...
const telegram = 'https://t.me/ItzSadnesseKun'; 
const kapanbotaktif = 'SETIAP KEINGINAN OWNER'; 
...
conn.on('user-presence-update', json => console.log(json.id + ' presence is => ' + json.type)) || console.log('Bot by ig:@mr.tersakiti_404')
